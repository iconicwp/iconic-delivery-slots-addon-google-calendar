...
Note: This plugin requires the Iconic WooCommerce Delivery Slots plugin and a Google Account with Google Calendar access.
...
Stay organized, manage your delivery schedules efficiently, and never miss a delivery slot again.
...
## Can I use the WooCommerce Delivery Slots plugin with other calendar services?
Currently, the plugin only supports Google Calendar. We are always looking to expand our features based on customer feedback, so stay tuned for future updates.

## What information is synced to my Google Calendar?
The plugin syncs all delivery slot information from your WooCommerce Delivery Slots plugin to your Google Calendar. This includes the delivery date, time, and any other details associated with the slot.

## Is my information secure?
Yes, we ensure that all data transferred between your WooCommerce store and your Google Calendar is securely encrypted. The API keys used for the syncing process are stored securely on your WordPress server.

## Can I sync my delivery slots to multiple Google Calendars?
