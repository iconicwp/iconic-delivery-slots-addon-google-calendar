...
function jckwds_gcal_settings( $wpsf_settings ) {
	...
	$gcal_fields = array(
		array(
			'id'       => 'api',
			'title'    => __( 'API Key', 'jckwds' ),
			'subtitle' => '',
			'type'     => 'text',
		),
		array(
			'id'       => 'secret',
			'title'    => __( 'Secret', 'jckwds' ),
			'subtitle' => '',
			'type'     => 'text',
		),
		array(
	...
	$wpsf_settings['sections'][] = array(
		'tab_id'              => 'integrations',
		'section_id'          => 'google',
		'section_title'       => __( 'Google Calender Authentication', 'jckwds' ),
		'section_description' => __( '', 'jckwds' ),
		'section_order'       => 0,
		'fields'              => $gcal_fields,
	);
	...
	$wpsf_settings['sections'][] = array(
		...
		'section_title'       => __( 'Google Calender Settings', 'jckwds' ),
		...
		'fields'              => array(
			...
			array(
				...
				'title'    => __( 'Event Description', 'jckwds' ),
				'subtitle' => '',
